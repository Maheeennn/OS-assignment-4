...
SORT_MPI_SRC = $(SRC_DIR)/sort_mpi.c
...
sort: $(BIN_DIR)/sort_seq $(BIN_DIR)/sort_pthread $(BIN_DIR)/sort_omp $(BIN_DIR)/sort_mpi
...
$(BIN_DIR)/sort_mpi: $(SORT_MPI_SRC)
$(MPICC) $(CFLAGS) -o $@ $(SORT_MPI_SRC)
